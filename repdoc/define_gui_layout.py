...
COLOR_ASIGNACION_HEAD = '#4D1657'
COLOR_ASIGNACION_EVEN = '#EECFF3'
COLOR_ASIGNACION_ODD = '#FAF0FC'
COLOR_ASIGNATURAS_HEAD = '#8B1210'
COLOR_ASIGNATURAS_EVEN = '#FCD9D6'
COLOR_ASIGNATURAS_ODD = '#FEF4F3'
COLOR_BITACORA_HEAD = '#7F4D0E'
COLOR_BITACORA_EVEN = '#FEEACD'
COLOR_BITACORA_ODD = '#FFF9F0'
COLOR_PROFESORES_HEAD = '#27562A'
COLOR_PROFESORES_EVEN = '#DBEEDC'
COLOR_PROFESORES_ODD = '#F4FAF4'
COLOR_TITULACIONES_HEAD = '#202A5A'
COLOR_TITULACIONES_EVEN = '#D8DCF0'
COLOR_TITULACIONES_ODD = '#F3F4FB'
